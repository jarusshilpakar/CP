...
<a href="ismt.html" target="abc"> <button type="submit">Edit product</button></a><br><br><br>
<a href="ismt.html" target="abc"> <button type="submit">Edit profile</button></a><br><br><br>
