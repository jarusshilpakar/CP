...
<a href="<?php echo site_url('Welcome/editProduct')?>" target="abc"> <button type="submit">Edit product</button></a><br><br><br>
<a href="<?php echo site_url('Welcome/editProfile')?>" target="abc"> <button type="submit">Edit profile</button></a><br><br><br>
